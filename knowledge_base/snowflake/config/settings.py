...
class Settings(BaseSettings):
    ...
    # ── Knowledge Store ───────────────────────────────────────────────────
    # Directory where generated markdown knowledge base files are stored.
    # Each connected source gets its own .md file here.
    knowledge_store_path: str = "./knowledge_store"

    # ── Interview / Markdown Generation Model ────────────────────────────
    llm_model_interview: str  = "llama3.1:8b-instruct-q4_0"

    # ── Snowflake ─────────────────────────────────────────────────────────
    # account  : e.g. xy12345.us-east-1  (from your Snowflake URL before .snowflakecomputing.com)
    # warehouse: the virtual warehouse that runs queries
